...
export default class StarshipModel {
    constructor(data){
        ...
        this.megalight = data?.MGLT ? data.MGLT : "";
        ...
        this.hyperdriveRating = data?.hyperdrive_rating ? data.hyperdrive_rating : "";
        ...
        this.starshipClass = data?.starship_class ? data.starship_class : "";
        this.films = data;
        this.peoples = data;
    }
    ...
    get megalight() {
        return this._megalight;
    }
    set megalight(megalight) {
        this._megalight = megalight;
    }
    ...
    set hyperdriveRating(hyperdriveRating) {
    ...
    set starshipClass(starshipClass) {
